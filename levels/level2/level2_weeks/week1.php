                    ...
                    <div class="grid lg:grid-cols-2 md:grid-cols-2 col-span-1 gap-4 px-4">
                        ...
                        <div class="lg:col-span-2 md:col-span-2 col-span-1 h-auto bg-white ">
                            ...
                            <h3 class="text-lg font-semibold mb-2">Day 1 Video Lecture</h3>
                                ...
                                <a href="https://drive.google.com/file/d/11ePhWdxaMefBg2WQjhshDNhZpHM0LvDj/view?usp=sharing"><button class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md">Watch
                                    Video</button></a>
                        ...
                        <div class="col-span-1 h-auto bg-white ">
                            ...
                            <h3 class="text-lg font-semibold mb-2">Day 2 Video Lecture</h3>
                                <!-- Placeholder for the button to watch the video -->
                                <a href="https://drive.google.com/file/d/1kHs2sJaXPri4FOJ9c-dtdArg7WjUng3E/view?usp=sharing"><button class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md">Watch
                                    Video</button></a>
                        ...
                        <div class="col-span-1 h-auto bg-white ">
                            ...
                            <h3 class="text-lg font-semibold mb-2">Day 3 Video Lecture</h3>
                                <!-- Placeholder for the button to watch the video -->
                                <a href="https://drive.google.com/file/d/1fdc8Q7jrEM0RN3trNrJromV5PxT8QyHn/view?usp=sharing"><button class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md">Watch
                                    Video</button></a>
                        ...
                        <div class="col-span-1 h-auto bg-white ">
                            ...
                            <h3 class="text-lg font-semibold mb-2">Day 4 Video Lecture</h3>
                                <!-- Placeholder for the button to watch the video -->
                                <a href="https://drive.google.com/file/d/1CH-WJHEhXaw6eAJ29ZhEso-rI1Ct6n4q/view?usp=sharing"><button class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md">Watch
                                    Video</button></a>
                        ...
                        <div class="col-span-1 h-auto bg-white ">
                            ...
                            <h3 class="text-lg font-semibold mb-2">Day 5 Video Lecture</h3>
                                <!-- Placeholder for the button to watch the video -->
                                <a href="https://drive.google.com/file/d/1Beszs6ZMTJGAvBYdOCubIbHV6msVfpVk/view?usp=sharing"><button class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md">Watch
                                    Video</button></a>
                                    <a href="https://docs.google.com/document/d/1JnCVTQtgrK_ZH2oSJQ5Y6ULo70vEN0evoFDTR2GWdDs/edit?usp=sharing"><button class="bg-white hover:bg-gray-200 text-blue-500 border border-blue-700 px-4 py-2 rounded-md">Day Task</button></a>
                        </div>
                    </div>
                </div>
            </div>
