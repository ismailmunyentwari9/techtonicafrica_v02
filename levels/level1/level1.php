                ...
                <div class="lg:w-[95%] md:w-[95%] w-[97%]  py-4 mx-auto">
                    ...
                    <div class="grid lg:grid-cols-4 md:grid-cols-2 grid-1 gap-4 mt-8">
                        ...
                        <div class="bg-white rounded-lg shadow-md p-4">
                            ...
                            <p>Advanced HTML.</p>
                            <a href="./level1_weeks/week2.php"><button onclick="showCredentialsBox()"
                                class="block mt-4 bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md text-center">Access
                                This Week </button></a>
                        </div>
                        ...
                        <div class="bg-white rounded-lg shadow-md p-4">
                            ...
                            <p>CSS Basics.</p>
                            <a href="./level1_weeks/week3.php"><button onclick="showCredentialsBox()"
                                class="block mt-4 bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md text-center">Access
                                This Week </button></a>
                        </div>
                        ...
                        <div class="bg-white rounded-lg shadow-md p-4">
                            ...
                            <p>Advanced CSS.</p>
                            <a href="./level1_weeks/week4.php"><button onclick="showCredentialsBox()"
                                class="block mt-4 bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md text-center">Access
                                This Week </button></a>
                        </div>
                        ...
                        <div class="bg-white rounded-lg shadow-md p-4">
                            ...
                            <a href="./level1_weeks/week5.php"><button onclick="showCredentialsBox()"
                                class="block mt-4 bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md text-center">Access
                                This Week </button></a>
                        </div>
                        <!-- Week 6 -->
                        <div class="bg-white rounded-lg shadow-md p-4">
                            ...
                            <a href="./level1_weeks/week6.php"><button onclick="showCredentialsBox()"
                                class="block mt-4 bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md text-center">Access
                                This Week </button></a>
                        </div>
                        <!-- Week 7 -->
                        <div class="bg-white rounded-lg shadow-md p-4">
                            ...
                            <a href="./level1_weeks/week7.php"><button onclick="showCredentialsBox()"
                                class="block mt-4 bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md text-center">Access
                                This Week </button></a>
                        </div>
                        <!-- Week 8 -->
                        <div class="bg-white rounded-lg shadow-md p-4">
                            ...
                            <a href="./level1_weeks/week8.php"><button onclick="showCredentialsBox()"
                                class="block mt-4 bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md text-center">Access
                                This Week </button></a>
                        </div>
                        <!-- Week 9 -->
                        <div class="bg-white rounded-lg shadow-md p-4">
                            ...
                            <a href="./level1_weeks/week9.php"><button onclick="showCredentialsBox()"
                                class="block mt-4 bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md text-center">Access
                                This Week </button></a>
                        </div>
                        <!-- Week 10 -->
                        <div class="bg-white rounded-lg shadow-md p-4">
                            ...
                            <a href="./level1_weeks/week10.php"><button onclick="showCredentialsBox()"
                                class="block mt-4 bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md text-center">Access
                                This Week </button></a>
                        </div>
                        <!-- Week 11 -->
                        <div class="bg-white rounded-lg shadow-md p-4">
                            ...
                            <a href="./level1_weeks/week11.php"><button onclick="showCredentialsBox()"
                                class="block mt-4 bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md text-center">Access
                                This Week </button></a>
                        </div>
                        <!-- Week 12 -->
                        <div class="bg-white rounded-lg shadow-md p-4">
                            ...
                            <a href="./level1_weeks/week12.php"><button onclick="showCredentialsBox()"
                                class="block mt-4 bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md text-center">Access
                                This Week </button></a>
                        </div>
                    </div>
