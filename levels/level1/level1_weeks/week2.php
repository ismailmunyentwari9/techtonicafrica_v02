                    ...
                    <div class="grid lg:grid-cols-2 md:grid-cols-2 col-span-1 gap-4 px-4">
                        ...
                        <div class="lg:col-span-2 md:col-span-2 col-span-1 h-auto bg-white ">
                            ...
                            <h3 class="text-lg font-semibold mb-2">Day 1 Video Lecture</h3>
                                ...
                                <a href="https://drive.google.com/file/d/1z6_Nce7E9-cQfPxeBqDO_hLuJXL6fJcP/view?usp=sharing"><button class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md">Watch
                                    Video</button></a>
                        ...
                        <div class="col-span-1 h-auto bg-white ">
                            ...
                            <h3 class="text-lg font-semibold mb-2">Day 2 Video Lecture</h3>
                                <!-- Placeholder for the button to watch the video -->
                                <a href="https://drive.google.com/file/d/16G7eNTySwTJH7390jeqTmxClEAv_lOKJ/view?usp=sharing"><button class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md">Watch
                                    Video</button></a>
                        ...
                        <div class="col-span-1 h-auto bg-white ">
                            ...
                            <h3 class="text-lg font-semibold mb-2">Day 3 Video Lecture</h3>
                                <!-- Placeholder for the button to watch the video -->
                                <a href="https://drive.google.com/file/d/175bGOrd-bc0KIYsWzIBqi9cnQj-2tbRF/view?usp=sharing"><button class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md">Watch
                                    Video</button></a>
                        ...
                        <div class="col-span-1 h-auto bg-white ">
                            ...
                            <h3 class="text-lg font-semibold mb-2">Day 4 Video Lecture</h3>
                                <!-- Placeholder for the button to watch the video -->
                                <a href="https://drive.google.com/file/d/1NcUCsvuHIZEqE7GTz2n1Z0_d7mPyXwdu/view?usp=sharing"><button class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md">Watch
                                    Video</button></a>
                        ...
                        <div class="col-span-1 h-auto bg-white ">
                            ...
                            <h3 class="text-lg font-semibold mb-2">Day 5 Video Lecture</h3>
                                <!-- Placeholder for the button to watch the video -->
                                <a href="https://drive.google.com/file/d/1-gSvNpzcYrST7xgG8ALzJommN2Hp5QJK/view?usp=sharing"><button class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md">Watch
                                    Video</button></a>
                                    <a href="https://docs.google.com/document/d/1wz7ERSKW0CuKh2TkFC_n4ABPHMKvoK7yOJ0oDkE92X0/edit?usp=sharing"><button class="bg-white hover:bg-gray-200 text-blue-500 border border-blue-700 px-4 py-2 rounded-md">Day Task</button></a>
                        </div>
                    </div>
                </div>
            </div>
