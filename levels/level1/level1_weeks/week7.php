        ...
        <section class="w-full grid grid-cols-12">
                    ...
                    <div class="grid lg:grid-cols-2 md:grid-cols-2 col-span-1 gap-4 px-4">
                        ...
                        <div class="lg:col-span-2 md:col-span-2 col-span-1 h-auto bg-white ">
                            ...
                            <h3 class="text-lg font-semibold mb-2">Day 1 Video Lecture</h3>
                                ...
                                <a href="https://drive.google.com/file/d/1pouASnAOSCVprD1gZcfAdicNPT5jS23e/view?usp=sharing"><button class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md">Watch
                                    Video</button></a>
                        ...
                        <div class="col-span-1 h-auto bg-white ">
                            ...
                            <h3 class="text-lg font-semibold mb-2">Day 2 Video Lecture</h3>
                                <!-- Placeholder for the button to watch the video -->
                                <a href="https://drive.google.com/file/d/1oHbQAuyweEbSiPPmObZuRlGn4aDLb1H6/view?usp=sharing"><button class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md">Watch
                                    Video</button></a>
                        ...
                        <div class="col-span-1 h-auto bg-white ">
                            ...
                            <h3 class="text-lg font-semibold mb-2">Day 3 Video Lecture</h3>
                                <!-- Placeholder for the button to watch the video -->
                                <a href="https://drive.google.com/file/d/1v8JdgEgIl2k58vZ5jtjRm8Tr88Xa4qEZ/view?usp=sharing"><button class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md">Watch
                                    Video</button></a>
                        ...
                        <div class="col-span-1 h-auto bg-white ">
                            ...
                            <h3 class="text-lg font-semibold mb-2">Day 4 Video Lecture</h3>
                                <!-- Placeholder for the button to watch the video -->
                                <a href="https://drive.google.com/file/d/1C4DHOwR86cdZhr4lvTcwkqwY_IXNQpY9/view?usp=sharing"><button class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md">Watch
                                    Video</button></a>
                        ...
                        <div class="col-span-1 h-auto bg-white ">
                            ...
                            <h3 class="text-lg font-semibold mb-2">Day 5 Video Lecture</h3>
                                <!-- Placeholder for the button to watch the video -->
                                <a href="https://drive.google.com/file/d/1ji_V2aT4MR8h0LAx6HNUksIBm4X3RWBL/view?usp=sharing"><button class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md">Watch
                                    Video</button></a>
                                    <a href="https://docs.google.com/document/d/1KQbtJQiVahNg7Ps30F___lTGrA0oVW6lZvtxphFY9M0/edit?usp=sharing"><button class="bg-white hover:bg-gray-200 text-blue-500 border border-blue-700 px-4 py-2 rounded-md">Day Task</button></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div id="credentialsBox"
                ...
                <div class="flex justify-between">
                    ...
                    <a href="../../../1dailyAlert.php"><button class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md">Watch
                        Video</button></a>
                        <a href="../../../1dailyAlert.php"><button class="bg-white hover:bg-gray-200 text-blue-500 border border-blue-700 px-4 py-2 rounded-md">Day Task</button></a>
                </div>
                <div class="mt-4">
