                    ...
                    <div class="grid lg:grid-cols-2 md:grid-cols-2 col-span-1 gap-4 px-4">
                        ...
                        <div class="lg:col-span-2 md:col-span-2 col-span-1 h-auto bg-white ">
                            ...
                            <h3 class="text-lg font-semibold mb-2">Day 1 Video Lecture</h3>
                                ...
                                <a href="https://drive.google.com/file/d/1Yj0PgkItzhN3-vphMB2COBiUzobHEPXN/view?usp=sharing"><button class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md">Watch
                                    Video</button></a>
                        ...
                        <div class="col-span-1 h-auto bg-white ">
                            ...
                            <h3 class="text-lg font-semibold mb-2">Day 2 Video Lecture</h3>
                                <!-- Placeholder for the button to watch the video -->
                                <a href="https://drive.google.com/file/d/1upS9DA85gOVw3BpiMRcoSqzp5vpLfISh/view?usp=sharing"><button class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md">Watch
                                    Video</button></a>
                        ...
                        <div class="col-span-1 h-auto bg-white ">
                            ...
                            <h3 class="text-lg font-semibold mb-2">Day 3 Video Lecture</h3>
                                <!-- Placeholder for the button to watch the video -->
                                <a href="https://drive.google.com/file/d/1RP667sxt6tI8At8n_bpMRte6FM8Knvrv/view?usp=sharing"><button class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md">Watch
                                    Video</button></a>
                        ...
                        <div class="col-span-1 h-auto bg-white ">
                            ...
                            <h3 class="text-lg font-semibold mb-2">Day 4 Video Lecture</h3>
                                <!-- Placeholder for the button to watch the video -->
                                <a href="https://drive.google.com/file/d/1OlGtdT9WrD4Pj05G5fvQScgq4dsCGd-B/view?usp=sharing"><button class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md">Watch
                                    Video</button></a>
                        ...
                        <div class="col-span-1 h-auto bg-white ">
                            ...
                            <h3 class="text-lg font-semibold mb-2">Day 5 Video Lecture</h3>
                                <!-- Placeholder for the button to watch the video -->
                                <a href="https://drive.google.com/file/d/13768BZAa1P7Rj5dAZr_VVepNaRML2gOG/view?usp=sharing"><button class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md">Watch
                                    Video</button></a>
                                    <a href="https://docs.google.com/document/d/14_yxOt0WqxKIg1v9LXaucTkokB6lDlAk1CdX3TG4jEo/edit?usp=sharing"><button class="bg-white hover:bg-gray-200 text-blue-500 border border-blue-700 px-4 py-2 rounded-md">Day Task</button></a>
                        </div>
                    </div>
                </div>
            </div>
